...
CREATE TABLE `employeephonenumber` (
  `Employee Phone Number` varchar(10) NOT NULL,
  `employeeId` int NOT NULL,
  PRIMARY KEY (`Employee Phone Number`),
  KEY `iid_idx` (`employeeId`),
  CONSTRAINT `iid` FOREIGN KEY (`employeeId`) REFERENCES `employee` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
