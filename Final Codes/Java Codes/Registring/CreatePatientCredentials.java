...
final public class CreatePatientCredentials {
	private static MyLogger LOGGER;

	private CreatePatientCredentials() {

	}

	public static void createUsername(String username, String password, int patientId, String databaseUsername,
			String databasePassword) throws SQLException {
		String createUserProcedure = "{CALL healthclinicpro.CreatePatientUsernameAndStoreSecret(?, ?, ?, ?)}";
